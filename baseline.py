...
def validate(val_loader, model, args):
    ...
    if args.dataset == "kaggle":
        ...
        m = torch.sigmoid(torch.from_numpy(all_output))
        print("all_traget", all_target)
        print("sigmoid of all_output:", m)
        m = m > 0.5
        #pdb.set_trace()
        precision, recall, accuracy, f1 = calc_acc_pr_f1_overall(m, all_target)
